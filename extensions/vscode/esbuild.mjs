...
//
// VS Code loads `main` and everything it requires at activation; loose modules
// are one read and one resolution each, and the `.vsix` carries the tree.
// esbuild resolves it once, at build time.
//
