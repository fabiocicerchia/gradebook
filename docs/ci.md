...
```yaml
# pipx is preinstalled on GitHub-hosted runners, and sidesteps PEP 668 on
# any image whose python is externally managed. Pin a tag, so the gate
# never moves under you: https://github.com/fabiocicerchia/gradebook/releases
- run: pipx install "git+https://github.com/fabiocicerchia/gradebook.git@v0.4.0#subdirectory=gradebook-code"
